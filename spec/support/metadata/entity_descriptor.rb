...
RSpec.shared_examples 'EntityDescriptor xml' do
  ...
  before do
    create(:idp_sso_descriptor, entity_descriptor:) if create_idp
    if create_non_functioning_idp
      create(:idp_sso_descriptor, entity_descriptor:,
                                  enabled: false)
    end
    create(:sp_sso_descriptor, entity_descriptor:) if create_sp
    if create_aa
    ...
    if create_non_functioning_sp
      create(:sp_sso_descriptor, entity_descriptor:,
                                 enabled: false)
    end
    create(:mdattr_entity_attribute, entity_descriptor:) if add_entity_attributes
  end
