Sequel.migration do
  change do
    ...
    create_table(:federation_registry_objects) do
      ...
      column :internal_id, "int", :null=>false
      column :fr_id, "int", :null=>false
    end
    ...
    create_table(:known_entities) do
      primary_key :id, :type=>"int"
      column :enabled, "tinyint(1)", :null=>false
      column :entity_source_id, "int", :null=>false
      column :created_at, "datetime", :null=>false
      column :updated_at, "datetime", :null=>false
    end
    ...
    create_table(:api_subjects_roles) do
      foreign_key :role_id, :roles, :type=>"int", :null=>false, :key=>[:id]
      foreign_key :api_subject_id, :api_subjects, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:artifact_resolution_services) do
      primary_key :id, :type=>"int"
      foreign_key :sso_descriptor_id, :sso_descriptors, :type=>"int", :key=>[:id]
    ...
    create_table(:entity_descriptors) do
      primary_key :id, :type=>"int"
      foreign_key :organization_id, :organizations, :type=>"int", :key=>[:id]
      column :extensions, "text"
      column :created_at, "datetime"
      column :updated_at, "datetime"
      foreign_key :known_entity_id, :known_entities, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:federation_registry_sources) do
      primary_key :id, :type=>"int"
      foreign_key :entity_source_id, :entity_sources, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:metadata_instances) do
      ...
      column :created_at, "datetime"
      column :updated_at, "datetime"
      column :ca_verify_depth, "int"
      column :hash_algorithm, "varchar(255)", :null=>false
      foreign_key :keypair_id, :keypairs, :type=>"int", :null=>false, :key=>[:id]
      ...
      column :validity_period, "int", :null=>false
      column :cache_period, "int", :default=>21600, :null=>false
    ...
    create_table(:organization_display_names) do
      primary_key :id, :type=>"int"
      foreign_key :organization_id, :organizations, :type=>"int", :null=>false, :key=>[:id]
      column :created_at, "datetime"
      column :updated_at, "datetime"
    ...
    create_table(:roles_subjects) do
      foreign_key :role_id, :roles, :type=>"int", :null=>false, :key=>[:id]
      foreign_key :subject_id, :subjects, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:tags) do
      ...
      column :created_at, "datetime"
      column :updated_at, "datetime"
      foreign_key :known_entity_id, :known_entities, :type=>"int", :key=>[:id]
    ...
    create_table(:additional_metadata_locations) do
      ...
      column :created_at, "datetime"
      column :updated_at, "datetime"
      foreign_key :entity_descriptor_id, :entity_descriptors, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:attribute_authority_descriptors) do
      primary_key :id, :type=>"int"
      foreign_key :entity_descriptor_id, :entity_descriptors, :type=>"int", :key=>[:id]
    ...
    create_table(:ca_key_infos) do
      primary_key :id, :type=>"int"
      foreign_key :metadata_instance_id, :metadata_instances, :type=>"int", :key=>[:id]
    ...
    create_table(:entity_ids) do
      ...
      foreign_key :raw_entity_descriptor_id, :raw_entity_descriptors, :type=>"int", :key=>[:id]
      foreign_key :entity_source_id, :entity_sources, :type=>"int", :key=>[:id]
    ...
    create_table(:assertion_consumer_services) do
      primary_key :id, :type=>"int"
      foreign_key :sp_sso_descriptor_id, :sp_sso_descriptors, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:assertion_id_request_services) do
      primary_key :id, :type=>"int"
      foreign_key :idp_sso_descriptor_id, :idp_sso_descriptors, :type=>"int", :key=>[:id]
      foreign_key :attribute_authority_descriptor_id, :attribute_authority_descriptors, :type=>"int", :key=>[:id]
    ...
    create_table(:attribute_services) do
      primary_key :id, :type=>"int"
      foreign_key :attribute_authority_descriptor_id, :attribute_authority_descriptors, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:attributes) do
      ...
      foreign_key :idp_sso_descriptor_id, :idp_sso_descriptors, :type=>"int", :key=>[:id]
      foreign_key :attribute_authority_descriptor_id, :attribute_authority_descriptors, :type=>"int", :key=>[:id]
      foreign_key :entity_attribute_id, :entity_attributes, :type=>"int", :key=>[:id]
    ...
    create_table(:contact_people) do
      primary_key :id, :type=>"int"
      foreign_key :contact_id, :contacts, :type=>"int", :null=>false, :key=>[:id]
      column :contact_type_id, "int", :null=>false
      column :extensions, "text"
      column :created_at, "datetime"
      column :updated_at, "datetime"
      foreign_key :entity_descriptor_id, :entity_descriptors, :type=>"int", :key=>[:id]
      foreign_key :role_descriptor_id, :role_descriptors, :type=>"int", :key=>[:id]
    ...
    create_table(:disco_hints) do
      primary_key :id, :type=>"int"
      foreign_key :idp_sso_descriptor_id, :idp_sso_descriptors, :type=>"int", :null=>false, :key=>[:id]
      column :created_at, "datetime"
      column :updated_at, "datetime"
    ...
    create_table(:protocol_supports) do
      primary_key :id, :type=>"int"
      foreign_key :role_descriptor_id, :role_descriptors, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:registration_policies) do
      primary_key :id, :type=>"int"
      foreign_key :registration_info_id, :registration_infos, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:usage_policies) do
      primary_key :id, :type=>"int"
      foreign_key :publication_info_id, :publication_infos, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:attribute_values) do
      primary_key :id, :type=>"int"
      foreign_key :attribute_id, :attributes, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:descriptions) do
      primary_key :id, :type=>"int"
      foreign_key :ui_info_id, :ui_infos, :type=>"int", :key=>[:id]
    ...
    create_table(:domain_hints) do
      primary_key :id, :type=>"int"
      foreign_key :disco_hints_id, :disco_hints, :type=>"int", :key=>[:id]
    ...
    create_table(:encryption_methods) do
      ...
      column :created_at, "datetime"
      column :updated_at, "datetime"
      foreign_key :key_descriptor_id, :key_descriptors, :type=>"int", :null=>false, :key=>[:id]
    ...
    create_table(:key_infos) do
      ...
      column :created_at, "datetime"
      column :updated_at, "datetime"
      foreign_key :key_descriptor_id, :key_descriptors, :type=>"int", :key=>[:id]
    ...
    create_table(:name_formats) do
      primary_key :id, :type=>"int"
      foreign_key :attribute_id, :attributes, :type=>"int", :key=>[:id]
    ...
    create_table(:requested_attributes) do
      ...
      column :created_at, "datetime"
      column :updated_at, "datetime"
      foreign_key :attribute_consuming_service_id, :attribute_consuming_services, :type=>"int", :null=>false, :key=>[:id]
